#!/usr/bin/env python3
"""Query Universal Absorption Phase B evidence, W3 senses, and W5 relations."""
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Query Universal Absorption Phase B evidence/W3/W5 surfaces")
    ...
    evidence_path = repo / "knowledge/qa/universal-absorption-phase-b-evidence-bank.jsonl"
