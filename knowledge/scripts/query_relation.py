#!/usr/bin/env python3
"""Query W5 ISMISM relation assets."""
from __future__ import annotations

import argparse
from ismism_query_lib import as_json, contains_any, record_rows, relation_records, repo_root, row_title, truncate
...
def print_markdown(records, root, args) -> None:
    ...
    print(f"# W5 relation query: {title}")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Query W5 relation assets.")
