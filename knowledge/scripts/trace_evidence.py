#!/usr/bin/env python3
"""Trace W3/W5/row evidence back to clean segment text."""
from __future__ import annotations

import argparse
from ismism_query_lib import as_json, clean_path_for_row, relation_records, repo_root, row_title, segment_records, term_records, truncate, verify_quote_in_row
