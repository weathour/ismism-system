#!/usr/bin/env python3
"""Query W3 ISMISM term-sense records."""
from __future__ import annotations

import argparse
from pathlib import Path
from ismism_query_lib import as_json, contains_any, record_rows, repo_root, row_title, term_records, truncate
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Query W3 term-sense records.")
