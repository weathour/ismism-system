#!/usr/bin/env python3
"""
Validate W3 term sense records against the current corpus evidence layer.
...
- every evidence quote is an exact substring of its row's split_md_clean text.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Validate W3 term-senses.jsonl evidence.")
    ap.add_argument("--repo", default=".", help="repository root")
    ap.add_argument(
        "--term-senses",
        default="knowledge/lexicon/term-senses.jsonl",
    ...
    if args.json:
        ...
        print(
            f"W3 validation: records={checked_records}, terms={len(terms)}, "
