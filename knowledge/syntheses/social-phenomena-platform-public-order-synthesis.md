# Social Phenomena Phase 2 — Platform, Public Affect, Institution, and Class Synthesis
...
- main synthesis: `knowledge/themes/media-platform-public-opinion/media-platform-public-opinion-synthesis.md`
- focused synthesis: `knowledge/themes/media-platform-public-opinion/platform-traffic-attention-economy-synthesis.md`
- focused synthesis: `knowledge/themes/media-platform-public-opinion/public-opinion-fandom-network-cynicism-synthesis.md`
...
- W3 handles include: `平台社会`, `流量`, `短视频`, `直播平台`, `平台运营`, `广告投放`, `买流量`, `定向强化`, `注意力可用度`, `算法加权`, `推荐系统`, `舆论窗口`, `公众遗忘`, `网络犬儒`
...
- main synthesis: `knowledge/themes/governance-law-bureaucracy/governance-law-bureaucracy-synthesis.md`
- focused synthesis: `knowledge/themes/governance-law-bureaucracy/law-bureaucracy-rule-fetishism-synthesis.md`
- focused synthesis: `knowledge/themes/governance-law-bureaucracy/discipline-risk-security-governance-synthesis.md`
...
- main synthesis: `knowledge/themes/class-youth-generational-anxiety/class-youth-generational-anxiety-synthesis.md`
- focused synthesis: `knowledge/themes/class-youth-generational-anxiety/mobility-anxiety-class-solidification-synthesis.md`
- focused synthesis: `knowledge/themes/class-youth-generational-anxiety/youth-success-bottom-humiliation-synthesis.md`
...
7. Use W3/W5 only as draft handles and W10 only as pilot-draft close-reading aids.
...
python3 knowledge/scripts/query_media_platform_public_opinion_theme.py 网红 --limit 3
...
python3 knowledge/scripts/query_class_youth_generational_anxiety_theme.py 青年虚无 --limit 3
python3 knowledge/scripts/query_class_youth_generational_anxiety_theme.py 底层 --limit 3
```
