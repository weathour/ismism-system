...
- status: pilot-draft
- layer: `knowledge/themes/ai/` theme index/synthesis surface, not canonical corpus truth
- evidence: every node links to manifest row ids and representative evidence-bank ids
- validator: `python3 knowledge/scripts/validate_ai_theme.py --repo . --final` checks taxonomy row/class consistency
...
## Boundary rule
本 taxonomy 只提供 AI 主题检索轴；主要 claim 必须回链到 `ai-evidence-bank.jsonl`、W3/W5 draft assets 或 W10 pilot cards。
