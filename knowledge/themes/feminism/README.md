# Feminism / Gender / Sexuality / Social Reproduction Maximum Absorption Layer
...
- W3 batch: `W3-FEMINISM-2026-06-16` (78 draft term senses)
- W5 batch: `W5-FEMINISM-2026-06-16` (65 draft relation assets)
- W10 batch: `W10-FEMINISM-2026-06-16` (45 pilot-draft cards)
- validator: `python3 knowledge/scripts/validate_feminism_theme.py --repo . --final`
- query helper: `python3 knowledge/scripts/query_feminism_theme.py 女权 --limit 3`
...
- `feminism-w3-w5-batch-notes.md` — W3/W5 batch discipline and relation boundaries.
- four evidence-marker syntheses and `FEMINISM-MAXIMUM-ABSORPTION-HANDOFF.md`.

## Query examples

```bash
python3 knowledge/scripts/query_feminism_theme.py 女权 --limit 3
python3 knowledge/scripts/query_feminism_theme.py 厌女 --limit 3
python3 knowledge/scripts/query_feminism_theme.py 爱欲 --limit 3
python3 knowledge/scripts/query_feminism_theme.py --row 90
python3 knowledge/scripts/query_feminism_theme.py --class false-feminism-and-female-essence
```
