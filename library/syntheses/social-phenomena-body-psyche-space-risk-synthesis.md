# Social Topics Route 3 — Body, Psyche, Space, and Risk Synthesis

- status: G034 cross-theme synthesis; evidence-routed, not canonical ontology
- route_group: Social Topics Router
- integrates:
  - `library/themes/psychological-distress-social-symptom/`
  - `library/themes/urban-housing-migration-space/`
  - `library/themes/health-body-risk-society/`
...
- main synthesis: `library/themes/psychological-distress-social-symptom/psychological-distress-social-symptom-synthesis.md`
- focused synthesis: `library/themes/psychological-distress-social-symptom/anxiety-addiction-social-symptom-synthesis.md`
- focused synthesis: `library/themes/psychological-distress-social-symptom/private-psychologization-and-trauma-synthesis.md`
...
- main synthesis: `library/themes/urban-housing-migration-space/urban-housing-migration-space-synthesis.md`
- focused synthesis: `library/themes/urban-housing-migration-space/housing-migration-spatial-stratification-synthesis.md`
- focused synthesis: `library/themes/urban-housing-migration-space/rural-urban-public-space-synthesis.md`
...
- main synthesis: `library/themes/health-body-risk-society/health-body-risk-society-synthesis.md`
- focused synthesis: `library/themes/health-body-risk-society/medicalization-risk-body-governance-synthesis.md`
- focused synthesis: `library/themes/health-body-risk-society/epidemic-stigma-vulnerability-synthesis.md`
...
7. Keep concept/relation as draft handles and close-reading as pilot-draft close-reading aids.
...
python3 tools/query/themes/psychological_distress_social_symptom.py 成瘾 --limit 3
python3 tools/query/themes/psychological_distress_social_symptom.py 躺平 --limit 3
python3 tools/query/themes/psychological_distress_social_symptom.py 内耗 --limit 3

# Urban / housing / migration / space
python3 tools/query/themes/urban_housing_migration_space.py 城市 --limit 3
python3 tools/query/themes/urban_housing_migration_space.py 房子 --limit 3
python3 tools/query/themes/urban_housing_migration_space.py 迁移 --limit 3
python3 tools/query/themes/urban_housing_migration_space.py 公共空间 --limit 3
python3 tools/query/themes/urban_housing_migration_space.py 漂泊 --limit 3

# Health / body / medicine / risk society
python3 tools/query/themes/health_body_risk_society.py 身体 --limit 3
python3 tools/query/themes/health_body_risk_society.py 医疗 --limit 3
python3 tools/query/themes/health_body_risk_society.py 疾病 --limit 3
python3 tools/query/themes/health_body_risk_society.py 风险 --limit 3
python3 tools/query/themes/health_body_risk_society.py 健康 --limit 3
```
