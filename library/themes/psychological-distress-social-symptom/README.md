...
- status: G025 theme package closure complete; concept/relation/close-reading remain draft/pilot-draft
- date: 2026-06-16 CST
...
- close-reading batch: 30 Psychological-distress pilot-draft cards
- concept/relation notes: `psychological-distress-social-symptom-concept-relation-batch-notes.md`
...
- final validator: `tools/validate/themes/psychological_distress_social_symptom.py --repo . --final`
- query helper: `tools/query/themes/psychological_distress_social_symptom.py 焦虑 --limit 3`
...
5. G024 should add concept/relation draft records and close-reading pilot-draft cards without promoting prior draft statuses.
