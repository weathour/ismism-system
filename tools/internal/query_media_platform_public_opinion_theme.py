...
ROOT=Path('library/themes/media-platform-public-opinion')
...
def main():
    ap=argparse.ArgumentParser(description='Query Media / Platform / Public Opinion / Traffic Society theme evidence')
    ap.add_argument('query', help='keyword, row id, theme class, role, or evidence id')
    ap.add_argument('--limit', type=int, default=10)
    args=ap.parse_args(); q=args.query.strip()
