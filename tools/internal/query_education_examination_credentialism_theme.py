...
ROOT=Path('library/themes/education-examination-credentialism')
...
def main():
    ap=argparse.ArgumentParser(description='Query Education / Examination / Credentialism theme evidence')
    ...
    for r in manifest:
        ...
        ev_blob=' '.join(ev['evidence_id']+' '+ev.get('quote','')+' '+ev.get('trigger_keyword','') for ev in row_evs)
